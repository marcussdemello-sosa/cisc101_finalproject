...
-display the divisions of the original list into smaller parts

-show the sorting method applied to individual pairs

-show how the ordered pairs are then merged together
